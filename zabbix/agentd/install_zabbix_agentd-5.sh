...
#    wget -O /data/service/src/${ZABBIX_VERSION}.tar.gz https://cdn.zabbix.com/zabbix/sources/stable/5.0/zabbix-5.0.8.tar.gz
...
EOF
    ...
    mv /root/template_db_mysql.conf  ${ZABBIX_AGENTD_DIR}/etc/zabbix_agentd.conf.d/template_db_mysql.conf

    chown zabbix.zabbix  ${ZABBIX_AGENTD_DIR}/etc/zabbix_agentd.conf.d/template_db_mysql.conf
