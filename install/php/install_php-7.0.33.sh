...
function install_php70(){
    ...
    wget -O /data/service/src/php-7.0.33.tar.gz http://cn.php.net/distributions/php-7.0.33.tar.gz 
    ...
    sed -i 's@;cgi.fix_pathinfo.*@cgi.fix_pathinfo=1@' /data/service/php70/etc/php.ini
    ...
    echo 'export PATH=$PATH:/data/service/php70/bin/' >>/etc/profile
    echo 'export PATH=$PATH:/data/service/php70/sbin/' >>/etc/profile
...
#    echo 'extension = "openssl.so"' >> /data/service/php70/etc/php.ini
    ...
    # echo "cgi.fix_pathinfo=0"  >> /data/service/php70/etc/php.ini
