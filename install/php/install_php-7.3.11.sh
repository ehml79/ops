...
function install_php73(){
    ...
    --with-config-file-scan-dir=/data/service/php73/etc \
    ...
    sed -i 's@;emergency_restart_threshold.*@emergency_restart_threshold = 10@' /data/service/php73/etc/php-fpm.conf
    sed -i 's@;emergency_restart_interval.*@emergency_restart_interval = 1m@' /data/service/php73/etc/php-fpm.conf
    sed -i 's@;process_control_timeout.*@process_control_timeout = 5s@' /data/service/php73/etc/php-fpm.conf
    sed -i 's@;daemonize.*@daemonize = yes@' /data/service/php73/etc/php-fpm.conf
    ...
    sed -i 's@;listen.allowed_clients.*@listen.allowed_clients = 0.0.0.0@' /data/service/php73/etc/php-fpm.d/www.conf
    sed -i 's@pm =.*@pm = dynamic@' /data/service/php73/etc/php-fpm.d/www.conf
    sed -i 's@pm.max_children.*@pm.max_children = 256@' /data/service/php73/etc/php-fpm.d/www.conf
    sed -i 's@pm.start_servers.*@pm.start_servers = 20@' /data/service/php73/etc/php-fpm.d/www.conf
    sed -i 's@pm.min_spare_servers.*@pm.min_spare_servers = 5@' /data/service/php73/etc/php-fpm.d/www.conf
    sed -i 's@pm.max_spare_servers.*@pm.max_spare_servers = 35@' /data/service/php73/etc/php-fpm.d/www.conf
    sed -i 's@;pm.max_requests.*@pm.max_requests = 1024@' /data/service/php73/etc/php-fpm.d/www.conf
    sed -i 's@;pm.status_path.*@pm.status_path = /status@' /data/service/php73/etc/php-fpm.d/www.conf
    sed -i 's@;ping.path.*@ping.path = /ping@' /data/service/php73/etc/php-fpm.d/www.conf
    sed -i 's@;ping.response.*@ping.response = pong@' /data/service/php73/etc/php-fpm.d/www.conf
    sed -i 's@;request_slowlog_timeout.*@request_slowlog_timeout= 10@' /data/service/php73/etc/php-fpm.d/www.conf
    sed -i 's@;slowlog.*@slowlog = log/$pool.log.slow@' /data/service/php73/etc/php-fpm.d/www.conf
    sed -i 's@;rlimit_files.*@rlimit_files = 65535@' /data/service/php73/etc/php-fpm.d/www.conf
    sed -i 's@;rlimit_core.*@rlimit_core = 0@' /data/service/php73/etc/php-fpm.d/www.conf
    sed -i 's@;catch_workers_output.*@catch_workers_output = yes@' /data/service/php73/etc/php-fpm.d/www.conf
    # .do 访问
    sed -i 's@;security.limit_extensions.*@security.limit_extensions = .php .php3 .php4 .php5 .php7 .do@' /data/service/php73/etc/php-fpm.d/www.conf
    
    # 配置 /data/service/php73/etc/php.ini
    mkdir -p /data/service/php73/log/
    sed -i 's@; output_buffering@output_buffering = on@' /data/service/php73/etc/php.ini
    sed -i 's@; output_buffering.*@output_buffering = on@' /data/service/php73/etc/php.ini
    sed -i 's@short_open_tag.*@short_open_tag = On@' /data/service/php73/etc/php.ini
    sed -i 's@expose_php.*@expose_php = Off@' /data/service/php73/etc/php.ini
    sed -i 's@memory_limit.*@memory_limit = 2048M@' /data/service/php73/etc/php.ini
    sed -i 's@error_reporting.*@error_reporting = E_ALL \& \~E_DEPRECATED \& \~E_STRICT@' /data/service/php73/etc/php.ini
    ...
    # sed -i 's@; Development Value.*@; Development Value: On@' /data/service/php73/etc/php.ini
    # php 调试模式
    sed -i 's@; display_errors =.*@display_errors = On@' /data/service/php73/etc/php.ini
    ...
    ./configure --with-php-config=/data/service/php73/bin/php-config
    make && sudo make install
    echo "extension=mcrypt.so" >> /data/service/php73/etc/php.ini
    ...
    ./configure --with-php-config=/data/service/php73/bin/php-config
    make && sudo make install
    echo 'extension = "igbinary.so"' >> /data/service/php73/etc/php.ini
...
#    make
#    make install
#    echo 'extension = "openssl.so"' >> /data/service/php73/etc/php.ini
