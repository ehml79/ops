...
#wget https://cdn.mysql.com//Downloads/MySQL-8.0/mysql-8.0.13.tar.gz -P /data/service/src/
#wget https://dl.bintray.com/boostorg/release/1.67.0/source/boost_1_67_0.tar.gz  -P /data/service/src/

wget https://dev.mysql.com/get/Downloads/MySQL-8.0/mysql-8.0.13-linux-glibc2.12-x86_64.tar.xz -P /data/service/src/


cd /data/service/src
tar xf mysql-8.0.13-linux-glibc2.12-x86_64.tar.xz 
mv /data/service/src/mysql-8.0.13-linux-glibc2.12-x86_64 /data/service/mysql
